...
- Set `COPILOT_RESPONSE_TAG` to customize the response tag (default: `[AI Responder codex]`)
...
for i in $(seq 0 $((original_count - 1))); do
  ...
  # Configurable response tag (can be customized via COPILOT_RESPONSE_TAG env var)
